  ...
  return (
    <li>
      ...
      <ul className={`${styles.subMenu} ${styles.brands}`}>
        <li>
          <NavLink to="#">
            <img src={carbi} alt="CarBi Logo" />
            CarBi
          </NavLink>
        </li>
        <li>
          <NavLink to="#">
            <img src={eikosha} alt="Eikosha Logo" />
            Eikosha
          </NavLink>
        </li>
        <li>
          <NavLink to="#">
            <img src={kixx} alt="Kixx Logo" />
            Kixx
          </NavLink>
        </li>
        <li>
          <NavLink to="#">
            <img src={littleTrees} alt="Little Trees Logo" />
            Little Trees
          </NavLink>
        </li>
        <li>
          <NavLink to="#">
            <img src={mobil1} alt="Mobil 1 Logo" />
            Mobil 1
          </NavLink>
        </li>
        <li>
          <NavLink to="#">
            <img src={motip} alt="Motip Logo" />
            Motip
          </NavLink>
        </li>
        <li>
          <NavLink to="#">
            <img src={runway} alt="Runway Logo" />
            Runway
          </NavLink>
        </li>
        <li>
          <NavLink to="#">
            <img src={soft99} alt="Soft99 Logo" />
            Soft99
          </NavLink>
        </li>
        <li>
        ...
        <li>
          <NavLink to="#">
            <img src={turtleWax} alt="Turtle Wax Logo" />
            Turtle Wax
          </NavLink>
        </li>
        <li>
